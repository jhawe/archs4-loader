...
#' @param samples Subset of samples for which to create the file. Default: NULL
#'
#' @author Johann Hawe <johann.hawe@helmholtz-muenchen.de>
# ------------------------------------------------------------------------------
load_design <- function(fh5, samples=NULL) {
  ...
  design = cbind(sample=samples, tissue, series, organism, molecule,
